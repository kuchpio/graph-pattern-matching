#include "induced_minor_exact_matcher.h"
#include <algorithm>
...
std::optional<std::vector<vertex>> InducedMinorExactMatcher::match(const core::Graph& G, const core::Graph& H) {
...
std::optional<std::vector<vertex>> InducedMinorExactMatcher::inducedMinorRecursion(
...
bool InducedMinorExactMatcher::maxDegreeConstraint(const core::Graph& G, const core::Graph& H) {
