...
std::optional<std::vector<vertex>> InducedMinorHeuristic::tpRecursion(const core::Graph G,
...
core::Graph InducedMinorHeuristic::contractEdge(const core::Graph& G, vertex u, vertex v) {
