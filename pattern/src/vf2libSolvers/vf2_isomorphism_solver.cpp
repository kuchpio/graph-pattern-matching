...
bool pattern::Vf2IsomorphismSolver::match(const core::Graph& bigGraph, const core::Graph& smallGraph) {
...
std::optional<std::vector<vertex>> pattern::Vf2IsomorphismSolver::matching(const core::Graph& bigGraph,
